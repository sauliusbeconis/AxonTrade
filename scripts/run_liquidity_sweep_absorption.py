#!/usr/bin/env python3
"""Run liquidity sweep absorption signals and conservative outcomes."""
...
from axontrade.data import load_sierra_export_config, normalize_sierra_bar_study_file
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Evaluate liquidity sweep reversal with bid/ask absorption filters.",
    )
    ...
    parser.add_argument(
        ...
        help="Sierra export normalization config with bid/ask volume aliases.",
    )
    parser.add_argument(
        "--opening-range-start",
        default="09:30:00",
    ...
    signal_rows = evaluate_liquidity_sweep_absorption_reversal(normalized_rows)
