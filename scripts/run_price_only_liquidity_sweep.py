#!/usr/bin/env python3
"""Run price-only liquidity sweep reversal signals and outcomes."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Evaluate the price-only liquidity sweep reversal baseline.",
    )
    ...
    signal_rows = evaluate_price_only_liquidity_sweep_reversal(normalized_rows)
