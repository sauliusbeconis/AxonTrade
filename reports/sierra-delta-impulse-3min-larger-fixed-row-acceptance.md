...
- outcomes: `data/processed/AxonTrade_ES_delta_impulse_3min_larger_scaled_outcomes_all_5_10_8_initial.csv`
- sweep: `reports/sierra-delta-impulse-3min-larger-scaled-exit-sweep.csv`

## Gates

| Status | Gate | Observed | Required | Notes |
| --- | --- | ---: | ---: | --- |
| PASS | minimum_outcome_trades | 169 | >= 100 | Total evaluated fixed-row outcome trades. |
| PASS | minimum_trade_dates | 42 | >= 20 | Distinct trade dates represented by fixed-row outcomes. |
| FAIL | positive_holiday_adjusted_net | -14566.00 | > 0.00 | Net USD after excluding supplied holiday/early-close dates. |
...
| PASS | maximum_last_n_positive_day_net_share | 18.33% | <= 40.00% | Share of all positive daily net contributed by the final configured dates. |
...
| FAIL | nonnegative_holiday_adjusted_short_net | -8869.00 | >= 0.00 | Short-side net after excluding supplied holiday/early-close dates. |
...
| Trade dates | 42 |
| Holiday dates | 1 |
| Holiday-adjusted trades | 163 |
| Holiday-adjusted net USD | -14566.00 |
| Holiday-adjusted short net USD | -8869.00 |
| Holiday-adjusted fixed rolling holdout net USD | -13718.00 |
| Maximum drawdown USD | -21398.00 |
| Drawdown to net ratio | 100.00% |
| Last 3 positive day net share | 18.33% |
