...
- Bars export: `/home/saulius/WinePrefixes/SierraChart/drive_c/SierraChart/Data/AxonTrade_ES_OrderflowExport_DeltaImpulse_3Min_Larger.txt`
...
- expected candidates from bars: `169`
- Sierra candidate log rows: `169`
- matched rows: `169`
- missing rows: `0`
- unexpected rows: `0`
- field mismatches: `0`
- trade dates: `42`
- date range: `2026-03-23` through `2026-06-29`
